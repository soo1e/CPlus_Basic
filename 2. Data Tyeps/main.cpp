...
int main()
{
    ...
    cout << "int from double " << i << endl; // 추측해보세요. -> 버린다.

    f = 567.89; // 이것도 형변환 -> 뒤에 f가 없기 때문
    ...
    cout << boolalpha << true << endl;   // boolalpha -> 옵션. true로 출력
    cout << is_good << endl;             // false
    cout << noboolalpha << true << endl; // noboolalpha -> 옵션. 1로 출력
